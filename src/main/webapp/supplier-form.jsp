        ...
        <body>
            ...
            <div class="container">
                <div class="d-flex justify-between align-center mb-3">
                    <h1 class="page-title">
                        <i class="fas fa-${empty supplier ? 'plus' : 'edit'}"></i>
                    ...
                    <form action="supplier" method="post">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save"></i> ${empty supplier ? 'Add Supplier' : 'Update Supplier'}
                            </button>
                            <button type="reset" class="btn btn-secondary btn-lg">
                                <i class="fas fa-undo"></i> Reset
                            </button>
                            <a href="supplier?action=list" class="btn btn-outline btn-lg">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">
                            <i class="fas fa-phone"></i> Quick Contact Test
                        </h2>
                    </div>
                    <div class="dashboard-grid">
                        ...
                        <button onclick="testPhone()" class="btn btn-success" id="testPhoneBtn" disabled>
                            <i class="fas fa-phone"></i> Test Phone
                        </button>
                    </div>
                </div>
            </div>
